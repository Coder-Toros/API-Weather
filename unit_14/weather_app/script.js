...
function getWindDerection(data) {
...
function showWeather(data) {
  ...
  let windDerection = getWindDerection(data);

  let getWindDerectionElement = document.querySelector(".derection");
  getWindDerectionElement.innerHTML = `Wind derection:${windDerection}`;
